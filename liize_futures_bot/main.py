...
def check_price_difference():
    ...
    for contract in contracts:
        ...
        with open(r"C:\Users\Sborka Park\PycharmProjects\liize_futures_bot\ignore.txt", "r", encoding="utf-8") as file:
        ...
        if None in [mexc_price_buy, mexc_price_sell, mexc_price, dex_price]:
            continue
        ...
        if difference_buy >= 4 and contract["deposit_enable"]:
            message = (
                f"📈 Network! {network}\n"
        ...
        elif difference_sell <= -4 and contract["withdraw_enable"]:
            min_amount = (withdraw_fee / abs(difference_sell)) * (100 + abs(difference))
            message = (
                f"📈 Network! {network}\n"
                f"📈 Arbitrage is possible!\n\n"
                f"🔹 **Coin**: {symbol}\n"
                ...
                f"💰 **Withdrawal fee**: {withdraw_fee:.10f} $\n"
